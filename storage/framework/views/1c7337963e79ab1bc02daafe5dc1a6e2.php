...
<?php echo $__env->make('content.data-management.partials.courses.page-style', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <select id="assignmentFilterFaculty" class="form-select">
                                ...
                                <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($faculty->id); ?>">
                                        <?php echo e(optional($faculty->user)->name); ?>
                                ...
                                <div class="dropdown-menu p-2">
                                    ...
                                    <div class="searchable-dropdown-list" data-dropdown-list>
                                        <?php $__currentLoopData = $sectionOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" class="dropdown-item" data-dropdown-option
                                                data-option-value="<?php echo e($section); ?>"
                                                data-option-label="<?php echo e($section); ?>">
        ...
        var list_methods = {
            ...
            saveAddMinor: function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('data-management/add-minor-course')); ?>",
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            saveAddMinorAssign: function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('data-management/save-add-minor-assign')); ?>", // adjust route
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            updateMinorCourse: function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('data-management/minor-courses/show')); ?>/" + id,
                    method: 'GET',
            ...
            saveUpdateMinor: function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('data-management/save-update-minors')); ?>/" + id,
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            saveUpdate: function(e) {
                ...
                formData.append('_token', "<?php echo e(csrf_token()); ?>");
                $.ajax({
                    url: "<?php echo e(url('users/save-update-users')); ?>/" + $id,
                    method: 'POST',
                    data: formData,
            ...
            deleteMinorCourse: function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo e(url('data-management/delete-minors-course')); ?>',
                            type: "PUT",
                            data: data,
                            dataType: "JSON",
            ...
            updateAssignMinor: function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('data-management/minor-assign-courses/show')); ?>/" + id,
                    method: 'GET',
                    success: function(res) {
                        // OPEN MODAL
            ...
            saveUpdateMinorAssign: function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('data-management/save-update-minor-assign')); ?>/" + id,
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            deleteAssignMinorCourse: function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('data-management/delete-assign-minors-course')); ?>",
                            type: "PUT",
                            data: data,
                            dataType: "JSON",
                        }).then(function(data, res, xhr) {
            ...
            script1.onload = function() {
                ...
                script2.onload = function() {
                    ...
                    minorTable = $('#courses-table-minor').DataTable({
                        ...
                        ajax: "<?php echo e(route('dm.minor.courses.list')); ?>",
                    ...
                    minorTableAssign = $('#assignments-table-course').DataTable({
                        ...
                        ajax: {
                            url: "<?php echo e(route('dm.minor.courses.assign.list')); ?>",
                            data: function(d) {
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/data-management/dm-minor-course.blade.php ENDPATH**/ ?>