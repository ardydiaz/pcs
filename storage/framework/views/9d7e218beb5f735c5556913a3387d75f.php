...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="course-tabs-header">
                        ...
                        <?php if($canImport): ?>
                            <div class="course-tab-actions">
                                <button type="button" class="btn btn-course-action" data-bs-toggle="modal" data-bs-target="#courseImportModal">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <select id="coursesRowsPerPage" class="form-select evaluation-page-size fw-bold" style="width: auto;" data-table-length>
                                ...
                                <?php if($canAdd): ?>
                                    <button type="button" class="btn btn-course-primary" data-bs-toggle="modal" data-bs-target="#courseCreateModal">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end align-items-center">
                                <div class="evaluation-search-wrapper">
                                    ...
                                    <input type="text" id="coursesSearch" class="evaluation-search-input" data-table-search placeholder="Search...">
                                    <button type="button" class="evaluation-search-clear" id="coursesSearchClear">&times;</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                            ...
                            <thead>
                                <tr>
                                    <?php if($canDelete || $showDeleteDisabled): ?>
                                        <th>
                                            <input type="checkbox" class="form-check-input evaluation-checkbox" id="coursesSelectAll">
                                        </th>
                                    <?php endif; ?>
                    ...
                    <?php if($canDelete || $showDeleteDisabled): ?>
                        <div class="evaluation-bulk-bar d-none" id="courseBulkBar">
                            ...
                            <?php if($canDelete): ?>
                                <button type="button" class="evaluation-bulk-btn evaluation-bulk-btn--danger" data-bulk-action="delete-course">
                            ...
                            <?php endif; ?>
                            <button type="button" class="evaluation-bulk-close" data-bulk-action="clear-course" title="Clear selection">
                                <i class="bx bx-x"></i>
                            </button>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <select id="assignmentsRowsPerPage" class="form-select evaluation-page-size fw-bold" style="width: auto;" data-table-length>
                                    <option value="10">10</option>
                                    <option value="25">25</option>
                                    <option value="50">50</option>
                                    <option value="100">100</option>
                                ...
                                <?php if($canAdd): ?>
                                    <button type="button" class="btn btn-course-primary" data-bs-toggle="modal" data-bs-target="#assignmentCreateModal">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end align-items-center gap-2 flex-wrap">
                                <div class="dropdown table-filter-dropdown">
                                    <button class="filter-toggle" type="button" id="assignmentFilterToggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span>Filters</span>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end p-3">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" class="btn btn-link p-0 table-filter-reset" id="assignmentFilterReset">Reset Filters</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="evaluation-search-wrapper">
                                    <i class="bx bx-search evaluation-search-icon"></i>
                                    <input type="text" id="assignmentsSearch" class="evaluation-search-input" data-table-search placeholder="Search...">
                                    <button type="button" class="evaluation-search-clear" id="assignmentsSearchClear">&times;</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                                ...
                                <tr>
                                    <?php if($canDelete || $showDeleteDisabled): ?>
                                        <th class="text-center">
                                            <input type="checkbox" class="form-check-input evaluation-checkbox" id="assignmentsSelectAll">
                                        </th>
                                    <?php endif; ?>
                    ...
                    <?php if($canDelete || $showDeleteDisabled): ?>
                        <div class="evaluation-bulk-bar d-none" id="assignmentBulkBar">
                            ...
                            <?php if($canDelete): ?>
                                <button type="button" class="evaluation-bulk-btn evaluation-bulk-btn--danger" data-bulk-action="delete-assignment">
                                    <i class="bx bx-trash"></i> Delete
                                </button>
                            <?php else: ?>
                                <button type="button" class="evaluation-bulk-btn evaluation-bulk-btn--danger disabled" disabled aria-disabled="true">
                            ...
                            <?php endif; ?>
                            <button type="button" class="evaluation-bulk-close" data-bulk-action="clear-assignment" title="Clear selection">
                                <i class="bx bx-x"></i>
                            </button>
                        </div>
                    <?php endif; ?>
    ...
    <?php if($canAdd): ?>
        ...
        <div class="modal fade" id="courseCreateModal" tabindex="-1" aria-labelledby="courseCreateModalLabel" aria-hidden="true">
                ...
                <div class="modal-content evaluation-card">
                    <form id="courseCreateForm">
                        ...
                        <div class="modal-header evaluation-modal-header">
                            <h5 class="modal-title mb-0" id="courseCreateModalLabel">Add Course</h5>
                        ...
                        <div class="modal-body evaluation-modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="class_code" id="createClassCode" class="form-control" placeholder="e.g. IT101" required>
                            </div>
                            <div class="mb-0">
                                <label class="form-label" for="createSubjectCode">Subject</label>
                                <input type="text" name="subject_code" id="createSubjectCode" class="form-control" placeholder="e.g. Introduction to IT" required>
                            </div>
                        </div>
                        <div class="modal-footer evaluation-modal-footer">
                            ...
                            <button type="submit" class="btn btn-course-primary evaluation-modal-btn" data-default-text="Save" data-loading-text="Saving...">Save</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="assignmentCreateModal" tabindex="-1" aria-labelledby="assignmentCreateModalLabel" aria-hidden="true">
            ...
            <div class="modal-content evaluation-card">
                <form id="assignmentCreateForm">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header evaluation-modal-header">
                        <h5 class="modal-title mb-0" id="assignmentCreateModalLabel">Assign Course</h5>
                        <button type="button" class="evaluation-modal-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                    </div>
                    <div class="modal-body evaluation-modal-body">
                        <div class="mb-3">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                        type="button"
                                        id="createAssignmentFacultyToggle"
                                ...
                                <div class="dropdown-menu p-2">
                                    ...
                                    <div class="searchable-dropdown-list" data-dropdown-list>
                                        <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $rawFacultyName = optional($faculty->user)->name ?? $faculty->name ?? '';
                                                $facultyEmail = optional($faculty->user)->email ?? '';
                                                $facultyDisplayName = trim($rawFacultyName) === '' ? 'Unknown' : $rawFacultyName;
                                                $facultyFilter = strtolower(trim($rawFacultyName . ' ' . $facultyEmail));
                                            ?>
                                            <button type="button"
                                                    class="dropdown-item"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                        type="button"
                                        id="createAssignmentCourseToggle"
                                        data-bs-toggle="dropdown"
                                        data-bs-display="static"
                                        data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder"
                                        ...
                                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                if ($courseSubjectDisplay !== '') {
                                                    $courseLabel = ($courseLabel !== '' ? $courseLabel . ' - ' : '') . $courseSubjectDisplay;
                                                }
                                                $courseFilter = strtolower(trim($courseCodeRaw . ' ' . $courseSubjectRaw));
                                            ?>
                                            <button type="button"
                                                    class="dropdown-item"
                                                    data-dropdown-option
                        ...
                        <div class="mb-3">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                        type="button"
                                        id="createAssignmentYearToggle"
                                        data-bs-toggle="dropdown"
                                        data-bs-display="static"
                                        data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder"
                                          data-dropdown-label
                                          data-placeholder-text="-- Select Academic Year --">-- Select Academic Year --</span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                        type="button"
                                        id="createAssignmentSemesterToggle"
                                        data-bs-toggle="dropdown"
                                        data-bs-display="static"
                                        data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder"
                    ...
                    <div class="modal-footer evaluation-modal-footer">
                        <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-course-primary evaluation-modal-btn" data-default-text="Assign" data-loading-text="Assigning...">Assign</button>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <div class="modal-body evaluation-modal-body">
                            <div class="mb-3">
                                ...
                                <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                    <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                            type="button"
                                            id="editAssignmentFacultyToggle"
                                            data-bs-toggle="dropdown"
                                            data-bs-display="static"
                                            data-dropdown-toggle>
                                        <span class="searchable-dropdown-label is-placeholder"
                            ...
                            <div class="mb-0">
                                ...
                                <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                    <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                            type="button"
                                            id="editAssignmentSemesterToggle"
                                            data-bs-toggle="dropdown"
                                            data-bs-display="static"
                                            data-dropdown-toggle>
                                        <span class="searchable-dropdown-label is-placeholder"
    ...
    <div class="modal fade" id="courseImportModal" tabindex="-1" aria-labelledby="courseImportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <form method="POST" action="<?php echo e(route('dm.courses.import')); ?>" enctype="multipart/form-data" id="courseImportForm">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header evaluation-modal-header">
                    ...
                    <div class="modal-body evaluation-modal-body">
                        <div class="mb-0">
                            ...
                            <input type="file" class="form-control" id="courseImportFile" name="file" accept=".csv,.xlsx,.xls" required>
                            <small class="text-muted d-block mt-2">Headers: classcode, subjectcode, section, employeeno, academicyear, semester</small>
                        </div>
                    </div>
                    <div class="modal-footer evaluation-modal-footer">
                        <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-course-primary evaluation-modal-btn" data-default-text="Import" data-loading-text="Importing...">Import</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.coursePage = new CoursePage({
                courses: <?php echo json_encode($courseItems, 15, 512) ?>,
                assignments: <?php echo json_encode($assignmentItems, 15, 512) ?>,
                faculties: <?php echo json_encode($facultyOptions, 15, 512) ?>,
        ...
        function initSearchableDropdowns(context = document) {
            ...
            dropdowns.forEach((dropdown) => {
                ...
                const initialValue = hiddenInput?.value?.trim();
                if (initialValue) {
                    const initialOption = getOptions().find((option) => option.dataset.optionValue === initialValue);
        ...
        class CoursePage {
            constructor({ courses, assignments, faculties, coursesRoot, assignmentsRoot }) {
                ...
                this.assignmentFilters = { faculty: 'all', year: 'all', semester: 'all' };
                ...
                this.courseCreateModal = this.courseCreateModalEl && hasBootstrap ? new bootstrap.Modal(this.courseCreateModalEl) : null;
                this.courseEditModal = this.courseEditModalEl && hasBootstrap ? new bootstrap.Modal(this.courseEditModalEl) : null;
                this.courseDeleteModal = this.courseDeleteModalEl && hasBootstrap ? new bootstrap.Modal(this.courseDeleteModalEl) : null;
                this.courseBulkDeleteModal = this.courseBulkDeleteModalEl && hasBootstrap ? new bootstrap.Modal(this.courseBulkDeleteModalEl) : null;

                this.assignmentCreateModal = this.assignmentCreateModalEl && hasBootstrap ? new bootstrap.Modal(this.assignmentCreateModalEl) : null;
                this.assignmentEditModal = this.assignmentEditModalEl && hasBootstrap ? new bootstrap.Modal(this.assignmentEditModalEl) : null;
                this.assignmentDeleteModal = this.assignmentDeleteModalEl && hasBootstrap ? new bootstrap.Modal(this.assignmentDeleteModalEl) : null;
                this.assignmentBulkDeleteModal = this.assignmentBulkDeleteModalEl && hasBootstrap ? new bootstrap.Modal(this.assignmentBulkDeleteModalEl) : null;
                ...
                this.courseSortState = { key: null, direction: 'asc' };
                this.assignmentSortState = { key: null, direction: 'asc' };
                ...
                if (confirmAssignmentDelete) {
                    confirmAssignmentDelete.addEventListener('click', () => {
                        if (this.pendingAssignmentDeleteId) {
                            this.handleDeleteAssignment(confirmAssignmentDelete, this.pendingAssignmentDeleteId);
                        }
                    });
                }
                ...
                if (confirmAssignmentBulk) {
                    confirmAssignmentBulk.addEventListener('click', () => {
                        if (Array.isArray(this.pendingAssignmentBulk) && this.pendingAssignmentBulk.length) {
                            this.executeBulkAssignmentDelete(confirmAssignmentBulk, this.pendingAssignmentBulk.slice());
                        }
                    });
                }
            }
            ...
            ensureDropdownOption(hiddenInput, { value, label, description = '' }) {
                ...
                this.courseSortHeaders.forEach((header) => {
                    ...
                    header.addEventListener('click', () => {
                        ...
                        if (this.courseSortState.key === sortKey) {
                            this.courseSortState.direction = this.courseSortState.direction === 'asc' ? 'desc' : 'asc';
                        } else {
            ...
            initAssignmentSorting() {
                this.assignmentSortHeaders = Array.from(document.querySelectorAll('#assignmentsTable thead th[data-sort-key]'));
                this.assignmentSortHeaders.forEach((header) => {
                    ...
                    header.addEventListener('click', () => {
                        ...
                        if (this.assignmentSortState.key === sortKey) {
                            this.assignmentSortState.direction = this.assignmentSortState.direction === 'asc' ? 'desc' : 'asc';
                        } else {
            ...
            updateAssignmentSortIndicators() {
                ...
                this.assignmentSortHeaders.forEach((header) => {
                    ...
                    if (header.dataset.sortKey === this.assignmentSortState.key) {
                        const state = this.assignmentSortState.direction === 'asc' ? 'sorted-asc' : 'sorted-desc';
                        header.classList.add(state);
            ...
            buildCourseRow(course) {
                ...
                const actionsCell = (coursePermissions.canEdit || coursePermissions.canDelete || coursePermissions.showDeleteDisabled)
                    ? `
            ...
            buildCourseEmptyRow() {
                return `
                    <tr data-empty>
                        <td colspan="<?php echo e(($canDelete || $showDeleteDisabled) ? 5 : 4); ?>" class="text-center py-5">
            ...
            buildAssignmentEmptyRow() {
                return `
                    <tr data-empty>
                        <td colspan="<?php echo e(($canDelete || $showDeleteDisabled) ? 7 : 6); ?>" class="text-center py-5">
                            <div class="empty-state">
                                <i class="fa-solid fa-book display-4 text-muted mb-3"></i>
            ...
            syncAssignmentSelection() {
                ...
                const selectedVisible = rows.filter((row) => this.assignmentSelection.has(row.dataset.assignmentId)).length;
                if (selectedVisible === 0) {
                    this.assignmentSelectAll.checked = false;
                    this.assignmentSelectAll.indeterminate = false;
                } else if (selectedVisible === rows.length) {
            ...
            promptBulkAssignmentDelete() {
                const ids = Array.from(this.assignmentSelection).map((id) => Number(id)).filter((id) => !Number.isNaN(id));
                if (!ids.length) {
                    return;
                }
            ...
            openAssignmentEditModal(assignmentId) {
                ...
                if (courseField) {
                    ...
                    const courseLabel = [courseCode, courseSubject].filter(Boolean).join(' - ') || `Course #${courseValue}`;
            ...
            async handleUpdateCourse(form, data) {
                ...
                try {
                    const response = await fetch(`<?php echo e(route('dm.courses.update', ':id')); ?>`.replace(':id', this.currentCourseId), {
                        method: 'PUT',
                        headers: this.defaultHeaders(),
                        body: JSON.stringify(data),
                    });
            ...
            async executeBulkCourseDelete(button, ids) {
                ...
                try {
                    const response = await fetch('<?php echo e(route('dm.courses.bulk-destroy')); ?>', {
                        method: 'POST',
                        headers: this.defaultHeaders(),
            ...
            async handleUpdateAssignment(form, data) {
                ...
                try {
                    const response = await fetch(`<?php echo e(route('dm.faculty-courses.update', ':id')); ?>`.replace(':id', this.currentAssignmentId), {
                        method: 'PUT',
                        headers: this.defaultHeaders(),
                        body: JSON.stringify(data),
                    });
                    ...
                    const index = this.assignments.findIndex((item) => Number(item.id) === Number(this.currentAssignmentId));
                    if (index !== -1) {
            ...
            async handleDeleteAssignment(button, assignmentId) {
                ...
                try {
                    ...
                    this.assignments = this.assignments.filter((assignment) => Number(assignment.id) !== Number(assignmentId));
            ...
            async executeBulkAssignmentDelete(button, ids) {
                ...
                try {
                    const response = await fetch('<?php echo e(route('dm.faculty-courses.bulk-destroy')); ?>', {
                        method: 'POST',
                        headers: this.defaultHeaders(),
                        body: JSON.stringify({ ids }),
                    });
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/postclasssurvey.mcu.edu.ph/resources/views/content/data-management/dm-courses.blade.php ENDPATH**/ ?>