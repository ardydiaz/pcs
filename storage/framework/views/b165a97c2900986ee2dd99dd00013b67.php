      ...
      <div class="card-body">
        ...
        <div class="collapse" id="collapseExample">
          <div class="d-grid d-sm-flex p-4 border">
            <img src="<?php echo e(asset('assets/img/elements/1.jpg')); ?>" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2">
            <span>
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-4 mb-md-0">
            <div class="collapse multi-collapse" id="multiCollapseExample1">
              <div class="d-grid d-sm-flex p-4 border">
                <img src="<?php echo e(asset('assets/img/elements/2.jpg')); ?>" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2">
                <span>
          ...
          <div class="col-12 col-md-6">
            <div class="collapse multi-collapse" id="multiCollapseExample2">
              <div class="d-grid d-sm-flex p-4 border">
                <img src="<?php echo e(asset('assets/img/elements/3.jpg')); ?>" alt="collapse-image" height="125" class="me-6 mb-sm-0 mb-2">
                <span>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sneat\html-laravel-free-internal\full-version\resources\views/content/user-interface/ui-collapse.blade.php ENDPATH**/ ?>