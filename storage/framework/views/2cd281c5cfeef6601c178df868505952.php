 <!-- Extend the main content layout which includes the navbar -->
...
<?php $__env->startSection('title', 'Data Management - Courses'); ?> <!-- Set the page title for the courses data management page -->

<!-- Section for Page Styles component rendered from partials/courses/page-style.blade.php -->
<?php echo $__env->make('content.data-management.partials.courses.page-style', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- Include the page-specific styles for the courses data management page -->
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-danger">
            <ul class="mb-0">
                <?php $__currentLoopData = explode('<br>', session('error')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container-fluid">
        ...
        <?php echo $__env->make('content.data-management.partials.courses.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This includes the header section with title and action buttons -->

        <!-- Manage Courses Table Component -->
        <?php echo $__env->make('content.data-management.partials.courses.manage-courses-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This includes the table for managing courses -->

        <!-- Assign Course to Existing Faculty Table Component -->
        <?php echo $__env->make('content.data-management.partials.courses.assign-course-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This includes the table for managing course assignments -->
    ...
    <?php echo $__env->make('content.data-management.partials.courses.add-course-form-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Edit Course Form Modal Component -->
    <?php echo $__env->make('content.data-management.partials.courses.edit-course-form-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Delete Course Alert & Bulk Component -->
    <?php echo $__env->make('content.data-management.partials.courses.delete-alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Assign Course Form Modal Component -->
    <?php echo $__env->make('content.data-management.partials.courses.assign-course-form-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Edit Assignment Modal Component -->
    <?php echo $__env->make('content.data-management.partials.courses.edit-assignment-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Delete Assignment Alert & Bulk Component -->
    <?php echo $__env->make('content.data-management.partials.courses.delete-assignment-alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->

    <!-- Excel Import Modal Component -->
    <?php echo $__env->make('content.data-management.partials.courses.excel-import-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <!-- This is included as a separate partial component for better organization -->
<?php $__env->stopSection(); ?> <!-- End of Course Page Content Section -->
    ...
    <script>
        ...
        class CoursePage {
            ...
            async handleUpdateCourse(form, data) {
                ...
                try {
                    const response = await fetch(`<?php echo e(route('dm.courses.update', ':id')); ?>`.replace(':id', this
                        .currentCourseId), {
                        method: 'PUT',
                        headers: this.defaultHeaders(),
                        body: JSON.stringify(data),
            ...
            async handleUpdateAssignment(form, data) {
                ...
                try {
                    const response = await fetch(`<?php echo e(route('dm.faculty-courses.update', ':id')); ?>`.replace(':id', this
                        .currentAssignmentId), {
                        method: 'PUT',
                        headers: this.defaultHeaders(),
                        body: JSON.stringify(data),
            ...
            async handleDeleteAssignment(button, assignmentId) {
                ...
                try {
                    const response = await fetch(`<?php echo e(route('dm.faculty-courses.destroy', ':id')); ?>`.replace(':id',
                        assignmentId), {
                        method: 'DELETE',
                        headers: this.deleteHeaders(),
                    });
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/data-management/dm-courses.blade.php ENDPATH**/ ?>