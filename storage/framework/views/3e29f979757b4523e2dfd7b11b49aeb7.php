...
<?php $__env->startSection('title', 'User Management - Users'); ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="filterDepartment">
                                            ...
                                            <?php $__currentLoopData = $departmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(strtolower($department)); ?>"><?php echo e($department); ?></option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="filterJobTitle">
                                            <option value="all">All</option>
                                            <?php $__currentLoopData = $jobTitleOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(strtolower($jobTitle)); ?>"><?php echo e($jobTitle); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="filterRole">
                                            <option value="all">All</option>
                                            <?php $__currentLoopData = $roleOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(strtolower($option['value'])); ?>"><?php echo e($option['label']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="filterStatus">
                                            ...
                                            <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(strtolower($value)); ?>"><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered user-modal-dialog user-modal-dialog--narrow">
        <div class="modal-content user-modal-card">
            <form method="POST" action="<?php echo e(route('um.users.store')); ?>" id="addUserForm">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="dropdown w-100 department-multiselect" data-department-multiselect>
                            ...
                            <div class="dropdown-menu p-3">
                                ...
                                <div class="department-multiselect-list" data-department-list>
                                    <?php $__currentLoopData = $departmentSelectOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="department-multiselect-option"
                                               data-department-option
                                               data-value="<?php echo e($department); ?>"
                                               data-label="<?php echo e($department); ?>"
                                               data-search="<?php echo e(strtolower($department)); ?>">
                                            <input type="checkbox" class="form-check-input" data-department-checkbox value="<?php echo e($department); ?>">
                        ...
                        <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                            <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                ...
                                <span class="searchable-dropdown-label is-placeholder"
                                      data-dropdown-label
                                      data-placeholder-text="<?php echo e($rolePlaceholder); ?>"><?php echo e($rolePlaceholder); ?></span>
                        ...
                        <label class="form-label">Access Level</label>
                            ...
                            <div class="dropdown-menu p-3">
                                ...
                                <div class="access-multiselect-list" data-access-list>
                                    <?php $__currentLoopData = $accessLevelOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="access-multiselect-option"
                                               data-access-option
                                               data-value="<?php echo e($option['value']); ?>"
                                               data-label="<?php echo e($option['label']); ?>"
                                               data-search="<?php echo e(strtolower($option['label'])); ?>">
                                            <input type="checkbox" class="form-check-input" data-access-checkbox value="<?php echo e($option['value']); ?>">
                                            <span><?php echo e($option['label']); ?></span>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown id="editUserRoleDropdown">
                            <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                ...
                                <span class="searchable-dropdown-label is-placeholder"
                                      data-dropdown-label
                                      data-placeholder-text="<?php echo e($editRolePlaceholder); ?>"><?php echo e($editRolePlaceholder); ?></span>
                                <i class="bx bx-chevron-down fs-5"></i>
                            </button>
                            <div class="dropdown-menu p-2">
                                <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        ...
        const userDeleteUrlTemplate = "<?php echo e(route('um.users.destroy', ':id')); ?>";
        const userBulkDeleteUrl = "<?php echo e(route('um.users.bulk-destroy')); ?>";
        const userUpdateUrlTemplate = "<?php echo e(route('um.users.update', ':id')); ?>";
        const usersPayload = <?php echo json_encode($userPayload, 15, 512) ?>;
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/postclasssurvey.mcu.edu.ph/resources/views/content/user-management/users.blade.php ENDPATH**/ ?>