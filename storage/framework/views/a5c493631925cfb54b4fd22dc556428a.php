        ...
        <div class="card evaluation-card evaluation-card--table mb-4 mt-0 faculty-action-card">
            <div class="card-body d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap justify-content-center">
                    <?php if($canAdd): ?>
                        <button type="button" class="btn btn-faculty-action evaluation-modal-trigger" data-bs-toggle="modal" data-bs-target="#facultyCreateModal">
                            <i class="fa-solid fa-user-plus me-2"></i> Add Faculty
                        </button>
                    <?php endif; ?>
                    <?php if($canImport): ?>
                        <button type="button" class="btn btn-faculty-action evaluation-modal-trigger" data-bs-toggle="modal" data-bs-target="#facultyImportModal">
                            ...
                            <div class="user-dropdown w-100" data-user-dropdown>
                                ...
                                <div class="dropdown-menu p-2">
                                    <div class="user-dropdown-list" data-user-list>
                                        <?php $__currentLoopData = $eligibleUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <button type="button"
                                                    ...
                                                    data-user-name="<?php echo e($userDisplayName); ?>"
                                                    data-user-name-lower="<?php echo e(strtolower($user->name ?? '')); ?>"
                                                    data-user-email-lower="<?php echo e(strtolower($user->email ?? '')); ?>">
                                                <span><?php echo e($userDisplayName); ?></span>
                                                <?php if($user->email): ?>
                                    ...
                                    <div class="user-dropdown-list" data-user-list>
                                        <?php $__currentLoopData = $jobTitleOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button"
                                                    class="dropdown-item"
                                                    data-user-option
                                                    data-user-name="<?php echo e($jobTitle); ?>"
                                                    data-user-name-lower="<?php echo e(strtolower($jobTitle)); ?>"
...
<?php if($canImport): ?>
    ...
    <div class="modal fade" id="facultyImportModal" tabindex="-1" aria-labelledby="facultyImportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <form method="POST" action="<?php echo e(route('faculties.import')); ?>" enctype="multipart/form-data" id="facultyImportForm">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header evaluation-modal-header">
                    ...
                    <div class="modal-body evaluation-modal-body">
                        <div class="mb-0">
                            ...
                            <small class="text-muted d-block mt-2">Headers: employeeno, name, department, jobtitle, role, status</small>
                        </div>
                    </div>
                    <div class="modal-footer evaluation-modal-footer">
                        <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-faculty-primary evaluation-modal-btn" data-default-text="Import" data-loading-text="Importing...">Import</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/postclasssurvey.mcu.edu.ph/resources/views/content/data-management/dm-faculties.blade.php ENDPATH**/ ?>