        ...
        <div class="d-flex align-items-start row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <a href="<?php echo e(route('reports')); ?>" class="btn btn-sm btn-outline-primary">View Reports</a>
            </div>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-6 order-1 mb-6">
      <div class="card h-100">
        ...
        <div class="card-body">
          <ul class="p-0 m-0">
            <?php $__empty_1 = true; $__currentLoopData = $lowRatedFaculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <?php
                $facultyDepartments = collect(explode(',', $faculty->department ?? ''))
                  ->map(function ($value) {
                    return trim($value);
              ...
              <li class="d-flex align-items-center mb-5">
                ...
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                  ...
                  <div class="user-progress">
                    <span class="badge bg-label-danger"><?php echo e(number_format($faculty->avg_rating, 2)); ?></span>
                    <small class="text-muted">(<?php echo e($faculty->response_count); ?> responses)</small>
                  </div>
                </div>
              </li>
              ...
              <li class="d-flex align-items-start mb-4">
                ...
                <div class="d-flex w-100 flex-wrap flex-column gap-1">
                  <div class="d-flex justify-content-between align-items-center">
                    <h6 class="mb-0"><?php echo e($feedback->evaluation->resolved_faculty_name ?? 'Unknown Faculty'); ?></h6>
                    <small class="text-muted"><?php echo e($feedback->created_at->diffForHumans()); ?></small>
                  </div>
                  <small class="text-muted mb-1">
                    <?php echo e($feedback->resolved_course_name); ?> - Rating:
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/postclasssurvey.mcu.edu.ph/resources/views/content/dashboard/dashboards.blade.php ENDPATH**/ ?>