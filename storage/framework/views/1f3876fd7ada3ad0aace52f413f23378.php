                        ...
                        <tbody id="tableBody">
                            <?php $__empty_1 = true; $__currentLoopData = $evaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="table-row" data-evaluation-id="<?php echo e($evaluation->id); ?>"
                                    data-sort-faculty="<?php echo e(strtolower($evaluation->faculty->name)); ?>"
                                    ...
                                    <td>
                                        <span class="faculty-name"><?php echo e(ucwords(strtolower($evaluation->faculty->name))); ?></span>
                                    </td>
                                    <td class="evaluation-pill-cell">
                                        <span class="evaluation-pill"
                                            data-value="<?php echo e($evaluation->academic_year); ?>"><?php echo e($evaluation->academic_year); ?></span>
                                    </td>
                                    <td class="evaluation-pill-cell">
                                        <span class="evaluation-pill"
                                            data-value="<?php echo e(strtolower($evaluation->semester)); ?>"><?php echo e($evaluation->semester); ?></span>
                                    </td>
                                    <td>
                                        <div class="evaluation-link-box">
                                            ...
                                            <button type="button" class="evaluation-icon-btn"
                                                onclick="copyToClipboard('<?php echo e($evaluation->form_link); ?>')" title="Copy link">
                                    ...
                                    <td>
                                        <span class="evaluation-count-pill"><?php echo e($evaluation->responses->count()); ?></span>
                                    </td>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item"
                                                        onclick="showQrModal(<?php echo e($evaluation->id); ?>, '<?php echo e(ucwords(strtolower($evaluation->faculty->name))); ?>', '<?php echo e($evaluation->academic_year); ?>', '<?php echo e($evaluation->semester); ?>')">
                                                        Preview QR
                                                    </button>
                                                </li>
                                                <li>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        ...
        function handleEvaluationBulkDelete(ids, { bulkBar, selectedCountEl, selectAllEl, controller }) {
            ...
            fetch('<?php echo e(route('dm.evaluation.bulkDestroy')); ?>', {
                method: 'DELETE',
                headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\post-class-survey\resources\views/content/data-management/dm-evaluation.blade.php ENDPATH**/ ?>