        ...
        <div class="card evaluation-card evaluation-card--table mb-4 evaluation-action-card">
            <div class="card-body d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap justify-content-center">
                    <button type="button" class="btn btn-evaluation-action <?php echo e($canAdd ? '' : 'is-disabled'); ?>"
                        <?php if(!$canAdd): ?> disabled aria-disabled="true" <?php endif; ?> data-mdb-ripple-init
                        data-bs-toggle="modal" data-bs-target="#generateAllModal">
                        <i class="fa-solid fa-file-circle-plus me-2"></i>
                        Generate All
                    </button>
                    <button type="button" class="btn btn-evaluation-action <?php echo e($canAdd ? '' : 'is-disabled'); ?>"
                        <?php if(!$canAdd): ?> disabled aria-disabled="true" <?php endif; ?> data-bs-toggle="modal"
                        ...
                        <tbody id="tableBody">
                            <?php $__currentLoopData = $sortedEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="table-row" data-evaluation-id="<?php echo e($evaluation->id); ?>"
                                    ...
                                    data-sort-status="<?php echo e($status); ?>"
                                    data-sort-responses="<?php echo e($evaluation->responses->count()); ?>"
                                    ...
                                    <?php if($canDelete || $showDeleteDisabled): ?>
                                        <td class="text-center">
                                            <input type="checkbox" class="form-check-input evaluation-checkbox"
                                                data-row-select value="<?php echo e($evaluation->id); ?>"
                                                <?php if(!$canDelete): ?> disabled aria-disabled="true" <?php endif; ?>>
                                        </td>
                                    <?php endif; ?>
                                    <td>
                                    ...
                                    <td>
                                        <div class="evaluation-link-box">
                                            <span
                                                class="evaluation-link text-truncate"><?php echo e($evaluation->form_link); ?></span>
                                                ...
                                                <?php if($canViewReports || $canManageEvaluations || $canManageEvaluationQr): ?>
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('dm.evaluation.responses', $evaluation)); ?>?from=dm">
                                                            View Responses
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button
                                    ...
                                    data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder" data-dropdown-label
                                        data-placeholder-text="<?php echo e($generateAllSemesterPlaceholder); ?>"><?php echo e($generateAllSemesterPlaceholder); ?></span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search"
                        ...
                        <div class="mb-0">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button
                                    ...
                                    data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder" data-dropdown-label
                                        data-placeholder-text="<?php echo e($semesterPlaceholder); ?>"><?php echo e($semesterPlaceholder); ?></span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search"
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/data-management/dm-evaluation.blade.php ENDPATH**/ ?>