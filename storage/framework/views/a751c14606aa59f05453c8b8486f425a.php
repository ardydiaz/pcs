...
<div id="minorSection" class="minor-course-section">
        ...
        <div class="card-body pt-0">
            <div class="table-responsive">
                <table class="table align-middle mb-0 evaluation-table" id="assignmentsTable">
                    ...
                    <tbody id="minorassignmentsTableBody"></tbody>
                </table>
            </div>
...
<?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/data-management/partials/courses/minors-assign-course-table.blade.php ENDPATH**/ ?>