<?php
    ...
    $departmentFilterOptions = collect($predefinedDepartments)
        ->merge($evaluations->flatMap(function ($evaluation) {
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card evaluation-card evaluation-card--table mb-4 evaluation-action-card">
            <div class="card-body d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3">
                <div class="text-center text-lg-start">
                    ...
                    <p class="text-muted mb-0">Use the actions above to generate evaluation forms individually or for every faculty member.</p>
                </div>
                <div class="d-flex align-items-center gap-3 flex-wrap justify-content-center">
                    <button type="button"
                        class="btn btn-evaluation-action <?php echo e($canAdd ? '' : 'is-disabled'); ?>"
                        <?php if(!$canAdd): ?> disabled aria-disabled="true" <?php endif; ?>
                        data-mdb-ripple-init
                        data-bs-toggle="modal"
                        data-bs-target="#generateAllModal">
                    ...
                    <button type="button"
                        ...
                        <?php if(!$canAdd): ?> disabled aria-disabled="true" <?php endif; ?>
                        data-bs-toggle="modal"
                        data-bs-target="#generateEvaluationModal"
                        data-mdb-ripple-init>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <select id="evaluationRowsPerPage" class="form-select evaluation-page-size fw-bold" style="width: auto;" data-table-length>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-end align-items-center gap-2 flex-wrap">
                            <div class="dropdown table-filter-dropdown">
                                <button class="filter-toggle" type="button" id="evaluationFilterToggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span>Filters</span>
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-3">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-link p-0 table-filter-reset" id="evaluationFilterReset">Reset Filters</button>
                                    </div>
                                </div>
                            </div>
                            <div class="evaluation-search-wrapper">
                                <i class="bx bx-search evaluation-search-icon"></i>
                                <input type="text" id="evaluationSearch" class="evaluation-search-input" data-table-search placeholder="Search...">
                                <button type="button" class="evaluation-search-clear" id="evaluationSearchClear">&times;</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle mb-0 evaluation-table" id="evaluationTable">
                        <thead>
                            <tr>
                                <?php if($canDelete || $showDeleteDisabled): ?>
                                    <th class="evaluation-col-selection text-center">
                                        <input type="checkbox"
                                            ...
                                            id="evaluationSelectAll"
                                            data-select-all
                                            <?php if(!$canDelete): ?> disabled aria-disabled="true" <?php endif; ?>>
                                    </th>
                                <?php endif; ?>
                                ...
                                <th data-sort-key="responses" data-sort-type="number" class="sortable" data-sort-state="none">
                                    <span class="evaluation-sort-wrapper">
                        ...
                        <tbody id="tableBody">
                            <?php $__currentLoopData = $sortedEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evaluation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $facultyTitle = trim($facultyDisplayName . ($facultyEmail ? ' • ' . $facultyEmail : ''));
                                    ...
                                    $searchTerms = strtolower($facultyRawName . ' ' . $facultyEmail . ' ' . $facultyDepartmentLabel . ' ' . $evaluation->academic_year . ' ' . $evaluation->semester . ' ' . $statusTerm . ' ' . $evaluation->form_link);
                                ?>
                                <tr class="table-row" data-evaluation-id="<?php echo e($evaluation->id); ?>"
                                    data-sort-faculty="<?php echo e(strtolower($facultyRawName)); ?>"
                                    data-sort-department="<?php echo e($facultyDepartmentSort); ?>"
                                    data-sort-year="<?php echo e($evaluation->academic_year); ?>"
                                    data-sort-semester="<?php echo e(strtolower($evaluation->semester)); ?>"
                                    data-sort-status="<?php echo e($status); ?>" data-sort-responses="<?php echo e($evaluation->responses->count()); ?>"
                                    data-label-faculty="<?php echo e($facultyDisplayName); ?>"
                                    data-label-department="<?php echo e($facultyDepartmentLabel); ?>"
                                    data-label-semester="<?php echo e($evaluation->semester); ?>"
                                    data-label-status="<?php echo e($evaluation->is_active ? 'Active' : 'Inactive'); ?>"
                                    data-search="<?php echo e($searchTerms); ?>">
                                    <?php if($canDelete || $showDeleteDisabled): ?>
                                        <td class="text-center">
                                            <input type="checkbox"
                                                class="form-check-input evaluation-checkbox"
                                                data-row-select
                                                value="<?php echo e($evaluation->id); ?>"
                                                <?php if(!$canDelete): ?> disabled aria-disabled="true" <?php endif; ?>>
                                        </td>
                                    <?php endif; ?>
                                    <td>
                                        <div class="table-cell-stack is-wide" title="<?php echo e($facultyTitle); ?>">
                                            <span class="faculty-name"><?php echo e($facultyDisplayName); ?></span>
                                            <?php if($facultyEmail): ?>
                                                <small class="text-muted"><?php echo e($facultyEmail); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                        ...
                                        <div class="evaluation-pill-group">
                                            <?php $__empty_1 = true; $__currentLoopData = $facultyDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <span class="evaluation-pill"
                                                      ...
                                                      data-pill-value="<?php echo e(strtolower($department)); ?>"><?php echo e($department); ?></span>
                                    ...
                                    <td class="evaluation-pill-cell">
                                        <span class="evaluation-pill"
                                              ...
                                              data-pill-value="<?php echo e(strtolower($evaluation->academic_year)); ?>"><?php echo e($evaluation->academic_year); ?></span>
                                    </td>
                                    <td class="evaluation-pill-cell">
                                        <span class="evaluation-pill"
                                              data-pill-palette="blue"
                                              data-pill-value="<?php echo e(strtolower($evaluation->semester)); ?>"><?php echo e($evaluation->semester); ?></span>
                                    </td>
                                    <td>
                                        <div class="evaluation-link-box">
                                            <span class="evaluation-link text-truncate"><?php echo e($evaluation->form_link); ?></span>
                                            <button type="button" class="evaluation-icon-btn" onclick="copyToClipboard('<?php echo e($evaluation->form_link); ?>')" title="Copy link">
                                                <i class="bx bx-copy"></i>
                                            </button>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="evaluation-status evaluation-status--<?php echo e($status); ?>">
                                            <?php echo e($evaluation->is_active ? 'Active' : 'Inactive'); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="evaluation-count-pill"
                                              data-pill-palette="gray"
                                              data-pill-value="responses"><?php echo e($evaluation->responses->count()); ?></span>
                                    </td>
                                    <td class="actions-cell">
                                        <div class="dropdown evaluation-actions">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <?php if($canViewReports || $canManageEvaluations || $canManageEvaluationQr): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('dm.evaluation.responses', $evaluation)); ?>?from=dm">
                                                            View Responses
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                                                <li>
                                                    <button type="button"
                                                        ...
                                                        data-evaluation-id="<?php echo e($evaluation->id); ?>"
                                                        data-evaluation-faculty="<?php echo e(e($facultyDisplayName)); ?>"
                                                        data-evaluation-year="<?php echo e($evaluation->academic_year); ?>"
                                                        data-evaluation-semester="<?php echo e($evaluation->semester); ?>">
                                                        Preview QR
                                                    </button>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('dm.evaluation.qr.download', $evaluation)); ?>">
                                                        Download QR
                                                    </a>
                                                </li>
                                                <?php if($canEdit): ?>
                                                    <li>
                                                        <button type="button"
                                                            ...
                                                            data-toggle-url="<?php echo e(route('dm.evaluation.toggle', $evaluation)); ?>"
                                                            data-evaluation-id="<?php echo e($evaluation->id); ?>"
                                                            data-current-status="<?php echo e($status); ?>"
                                                            data-default-text="<?php echo e($evaluation->is_active ? 'Deactivate' : 'Activate'); ?>">
                                                            <?php echo e($evaluation->is_active ? 'Deactivate' : 'Activate'); ?>

                                                        </button>
                                                    </li>
                                                <?php elseif($canEvaluationQrOnly): ?>
                                                    <li>
                                                ...
                                                <?php endif; ?>
                                                <?php if(($canEdit && $canDelete) || $canEvaluationQrOnly || $showDeleteDisabled): ?>
                                                ...
                                                <?php if($canDelete): ?>
                                                    <li>
                                                        <button type="button"
                                                            ...
                                                            data-evaluation-name="<?php echo e(e($facultyDisplayName)); ?>"
                                                            data-delete-url="<?php echo e(route('dm.evaluation.destroy', $evaluation)); ?>"
                                                            data-evaluation-id="<?php echo e($evaluation->id); ?>">
                                                            Delete
                                                        </button>
                                                    </li>
                                                <?php elseif($canEvaluationQrOnly || $showDeleteDisabled): ?>
                                                    <li>
                                                        <button type="button" class="dropdown-item disabled" disabled aria-disabled="true">
                                                            Delete
                                                        </button>
                                                    </li>
                                                <?php endif; ?>
                            ...
                            <tr data-empty style="<?php echo e($sortedEvaluations->isEmpty() ? '' : 'display: none;'); ?>">
                                <td colspan="<?php echo e(($canDelete || $showDeleteDisabled) ? 9 : 8); ?>" class="text-center py-5">
                                    <div class="empty-state">
                                        <i class="fa-solid fa-file-invoice display-4 text-muted mb-3"></i>
                                        <h5 class="mb-2">No evaluation forms found</h5>
                                        <p class="text-muted mb-0">Generate your first evaluation form using the controls above.</p>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="generateAllModal" tabindex="-1" aria-labelledby="generateAllModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <form method="POST" action="<?php echo e(route('dm.evaluation.generateAll')); ?>" id="generateAllFormModal">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body evaluation-modal-body">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                    ...
                                    <span class="searchable-dropdown-label is-placeholder"
                                          data-dropdown-label
                                          data-placeholder-text="<?php echo e($generateAllYearPlaceholder); ?>"><?php echo e($generateAllYearPlaceholder); ?></span>
                                ...
                                <div class="dropdown-menu p-2">
                                    ...
                                    <div class="searchable-dropdown-list" data-dropdown-list>
                                        <?php $__empty_1 = true; $__currentLoopData = $availableAcademicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php $yearValue = trim($year); ?>
                                            <button type="button"
                                                    class="dropdown-item"
                                                    data-dropdown-option
                                                    data-option-value="<?php echo e($yearValue); ?>"
                                                    data-option-label="<?php echo e($yearValue); ?>"
                                                    data-option-filter="<?php echo e(strtolower($yearValue)); ?>">
                                                <span><?php echo e($yearValue); ?></span>
                                            </button>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start" type="button" data-bs-toggle="dropdown" data-bs-display="static" data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder" data-dropdown-label data-placeholder-text="<?php echo e($generateAllSemesterPlaceholder); ?>"><?php echo e($generateAllSemesterPlaceholder); ?></span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
                                    <div class="searchable-dropdown-list" data-dropdown-list>
                                        <?php $__empty_1 = true; $__currentLoopData = $availableSemesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <button type="button"
                                                class="dropdown-item"
                                                data-dropdown-option
                                                data-option-value="<?php echo e($option['value']); ?>"
                                                data-option-label="<?php echo e($option['label']); ?>"
                                                data-option-filter="<?php echo e(strtolower($option['label'])); ?>">
                    ...
                    <div class="modal-footer evaluation-modal-footer">
                        ...
                        <button type="submit" class="btn btn-faculty-primary evaluation-modal-btn" data-default-text="Generate Forms" data-loading-text="Generating...">Generate Forms</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="generateEvaluationModal" tabindex="-1" aria-labelledby="generateEvaluationModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <form method="POST" action="<?php echo e(route('dm.evaluation.store')); ?>" id="generateEvaluationForm">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header evaluation-modal-header">
                    ...
                    <div class="modal-body evaluation-modal-body">
                        <div class="mb-3">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start" type="button" data-bs-toggle="dropdown" data-bs-display="static" data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder" data-dropdown-label data-placeholder-text="-- Select Faculty --">-- Select Faculty --</span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
                                    <div class="searchable-dropdown-list" data-dropdown-list>
                                        <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                $facultyName = trim($rawFacultyName) === '' ? 'Unknown' : $rawFacultyName;
                                                $facultyEmail = $faculty->email ?? '';
                                                $keywords = strtolower(trim(($faculty->name ?? 'Unknown') . ' ' . $facultyEmail));
                                            ?>
                                            <button type="button"
                                                class="dropdown-item"
                                                data-dropdown-option
                                                data-option-value="<?php echo e($faculty->id); ?>"
                                                data-option-label="<?php echo e($facultyName); ?>"
                                                data-option-filter="<?php echo e($keywords); ?>">
                                                <span><?php echo e($facultyName); ?></span>
                                                <?php if($facultyEmail): ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start"
                                    ...
                                    <span class="searchable-dropdown-label is-placeholder"
                                          data-dropdown-label
                                          data-placeholder-text="<?php echo e($modalYearPlaceholder); ?>"><?php echo e($modalYearPlaceholder); ?></span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="dropdown w-100 searchable-dropdown" data-searchable-dropdown>
                                <button class="searchable-dropdown-toggle w-100 d-flex justify-content-between align-items-center text-start" type="button" data-bs-toggle="dropdown" data-bs-display="static" data-dropdown-toggle>
                                    <span class="searchable-dropdown-label is-placeholder" data-dropdown-label data-placeholder-text="<?php echo e($semesterPlaceholder); ?>"><?php echo e($semesterPlaceholder); ?></span>
                                    <i class="bx bx-chevron-down fs-5"></i>
                                </button>
                                <div class="dropdown-menu p-2">
                                    <input type="text" class="form-control searchable-dropdown-search" placeholder="Search..." data-dropdown-search>
                    ...
                    <div class="modal-footer evaluation-modal-footer">
                        <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-faculty-primary evaluation-modal-btn" data-default-text="Generate" data-loading-text="Generating...">Generate</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="evaluationDeleteModal" tabindex="-1" aria-labelledby="evaluationDeleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <div class="modal-header evaluation-modal-header">
                ...
                <div class="modal-body evaluation-modal-body">
                    <p class="mb-0">Are you sure you want to delete <span class="fw-semibold" id="evaluationDeleteName">this evaluation form</span>? This action cannot be undone.</p>
                </div>
                <div class="modal-footer evaluation-modal-footer">
                    <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-delete-action evaluation-modal-btn" id="confirmEvaluationDeleteBtn" data-default-text="Delete" data-loading-text="Deleting...">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="evaluationBulkDeleteModal" tabindex="-1" aria-labelledby="evaluationBulkDeleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                <div class="modal-header evaluation-modal-header">
                ...
                <div class="modal-body evaluation-modal-body">
                    <p class="mb-0">You are about to delete <span class="fw-semibold" id="evaluationBulkDeleteCount">0</span> evaluation form(s). This action cannot be undone. Continue?</p>
                </div>
                <div class="modal-footer evaluation-modal-footer">
                    <button type="button" class="btn btn-tertiary evaluation-modal-btn" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-delete-action evaluation-modal-btn" id="confirmEvaluationBulkDeleteBtn" data-default-text="Delete Selected" data-loading-text="Deleting...">Delete Selected</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered evaluation-modal-dialog evaluation-modal-dialog--narrow">
            <div class="modal-content evaluation-card">
                ...
                <div class="modal-footer evaluation-modal-footer">
                    ...
                    <a id="downloadQrBtn" href="" class="btn btn-faculty-primary evaluation-modal-btn">Download QR Code</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            if (confirmBulkBtn) {
                confirmBulkBtn.addEventListener('click', () => {
                    if (pendingEvaluationBulk) {
                        ...
                        pendingEvaluationBulk = null;
                        handleEvaluationBulkDelete(context.ids, context.helpers, { loadingButton: confirmBulkBtn });
                    }
                });
            }
        });
        ...
        function initEvaluationSelection(controllerRoot, controller) {
            ...
            const getSelectableRows = () => {
                ...
                return Array.from(document.querySelectorAll('#evaluationTable tbody tr[data-evaluation-id]:not([data-ignore])'));
            };
            ...
            controllerRoot.addEventListener('table:updated', () => {
                ...
                lastScopeKey = scopeKey;
                document.querySelectorAll('#evaluationTable tbody tr[data-evaluation-id]:not([data-ignore])').forEach((row) => {
                    const id = row.dataset.evaluationId;
                    const checkbox = row.querySelector('[data-row-select]');
            ...
            if (bulkBar) {
                bulkBar.addEventListener('click', (event) => {
                    ...
                    handleEvaluationBulkAction(button.dataset.bulkAction, {
                        bulkBar, selectedCountEl, selectAllEl, controller
                    });
                });
            }
        }
        ...
        function handleEvaluationSort(activeHeader, headers, controller) {
            ...
            const rows = Array.from(document.querySelectorAll('#evaluationTable tbody tr[data-evaluation-id]:not([data-ignore])'));
            rows.sort((rowA, rowB) => {
        ...
        function handleEvaluationBulkAction(action, helpers) {
            ...
            if (action === 'delete') {
                pendingEvaluationBulk = { ids, helpers: { bulkBar, selectedCountEl, selectAllEl, controller } };
        ...
        function handleEvaluationBulkDelete(ids, { bulkBar, selectedCountEl, selectAllEl, controller }, options = {}) {
            ...
            return fetch('<?php echo e(route('dm.evaluation.bulkDestroy')); ?>', {
                method: 'DELETE',
                headers: {
            ...
            .then((payload) => {
                ids.forEach((id) => {
                    removeEvaluationRow(id, { skipRefresh: true });
                });
        ...
        function collectEvaluationFilterOptions() {
            ...
            rows.forEach((row) => {
                ...
                if (facultyValue && !sets.faculty.has(facultyValue)) {
                    sets.faculty.set(facultyValue, row.dataset.labelFaculty || row.dataset.sortFaculty || 'Unknown');
                }
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/postclasssurvey.mcu.edu.ph/resources/views/content/data-management/dm-evaluation.blade.php ENDPATH**/ ?>