...
<?php $__env->startSection('page-script'); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tableConfigs.forEach(({ id }) => {
            const root = document.querySelector(`[data-table-id="${id}"]`);
            if (root && window.TableController) {
                const controller = new TableController(root);
                window.tableControllers[id] = controller;
            }
        });
    });
    ...
    class CourseManager {
        ...
        refreshTableController(tableId) {
            const controller = window.tableControllers?.[tableId];
            if (controller) {
                controller.refresh();
            }
        }
        ...
        renderCoursesTable() {
            ...
            if (!this.courses.length) {
                ...
                `;
                this.refreshTableController('coursesTable');
                return;
            }
            ...
            this.courses.forEach(course => {
                ...
                row.dataset.search = [
                    course.class_code || '',
                    course.subject_code || '',
                    String(course.faculty_courses_count ?? '')
                ].join(' ').toLowerCase();
        ...
        renderAssignmentsTable() {
            ...
            if (!this.facultyCourses.length) {
                ...
                `;
                this.refreshTableController('assignmentsTable');
                return;
            }
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="courses" role="tabpanel">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card" data-table-controller data-table-id="coursesTable">
                        ...
                        <div class="px-3 pt-3 pb-3 border-bottom">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center">
                                        <label for="coursesRowsPerPage" class="form-label me-2 mb-0">Show:</label>
                                        <select id="coursesRowsPerPage" class="form-select form-select-sm" style="width: auto;" data-table-length>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-end">
                                        <div class="input-group" style="max-width: 320px;">
                                            ...
                                            <input type="text" id="coursesSearch" class="form-control" data-table-search
        ...
        <div class="tab-pane fade" id="assignments" role="tabpanel">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card" data-table-controller data-table-id="assignmentsTable">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">
                        ...
                        <div class="px-3 pt-3 pb-3 border-bottom">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center">
                                        <label for="assignmentsRowsPerPage" class="form-label me-2 mb-0">Show:</label>
                                        <select id="assignmentsRowsPerPage" class="form-select form-select-sm" style="width: auto;" data-table-length>
                                            <option value="10">10</option>
                                            <option value="25">25</option>
                                            <option value="50">50</option>
                                            <option value="100">100</option>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-end">
                                        <div class="input-group" style="max-width: 320px;">
                                            <span class="input-group-text"><i class="fas fa-search"></i></span>
                                            <input type="text" id="assignmentsSearch" class="form-control" data-table-search
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" id="assignmentsTable">
                                    ...
                                    <tbody id="assignmentsTableBody">
                                        <?php $__empty_1 = true; $__currentLoopData = $facultyCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\post-class-survey\resources\views/content/data-management/dm-courses.blade.php ENDPATH**/ ?>