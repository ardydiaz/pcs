        ...
        (function() {
            ...
            searchInput.addEventListener('input', (e) => {
                ...
                searchTimeout = setTimeout(async () => {
                    try {
                        const response = await fetch('<?php echo e(route("faculties.search-employee")); ?>', {
                            method: 'POST',
                            headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/data-management/partials/faculties/add-faculty-form-modal.blade.php ENDPATH**/ ?>