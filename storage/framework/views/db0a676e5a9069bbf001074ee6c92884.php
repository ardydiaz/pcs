...
<?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/form-basic-inputs.js'); ?>
    ...
    <div class="card mb-6">
      ...
      <div class="card-body">
        <div class="mb-4 row">
          ...
          <div class="col-md-10">
            <input class="form-control" type="text" value="<?php echo e(config('variables.templateName')); ?>" id="html5-text-input" />
          </div>
        </div>
        <div class="mb-4 row">
        ...
        <div class="mb-4 row">
          ...
          <div class="col-md-10">
            <input class="form-control" type="url" value="<?php echo e(config('variables.creatorUrl')); ?>" id="html5-url-input" />
          </div>
        </div>
        <div class="mb-4 row">
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sneat\html-laravel-free-internal\full-version\resources\views/content/form-elements/forms-basic-inputs.blade.php ENDPATH**/ ?>