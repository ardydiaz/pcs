        ...
        <form id="evaluationForm" method="POST"
            ...
            <div class="section-card active" data-section="1">
                <div class="header-section">
                    <h1><?php echo e($evaluation->faculty->name); ?></h1>
                    <p class="subtitle"><?php echo e($evaluation->faculty->department); ?></p>
            ...
            <div class="section-card" data-section="2">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text">Subject Code - Section - Subject Name</div>
                </div>
...
</html><?php /**PATH C:\laragon\www\faculty-evaluation\resources\views/content/data-management/evaluation-files/evaluation-form.blade.php ENDPATH**/ ?>