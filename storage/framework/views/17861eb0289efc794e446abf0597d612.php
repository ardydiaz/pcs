    ...
    <script>
        ...
        function createScheduleRow(schedule) {
            ...
            return `
                                                                                                                                                    ...
                                                                                                                                                    <td> ${schedule.faculty_course?.course?.class_code || 'N/A'} </td>
                                                                                                                                                    <td> ${schedule.time} </td>
                                                                                                                                                    <td> ${schedule.day} </td>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody id="schedulesTableBody">
                                    <?php $__empty_1 = true; $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="table-row" data-id="<?php echo e($schedule->id); ?>">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm me-3">
                                            ...
                                            <td>
                                                <span class="fw-medium"><?php echo e($schedule->day); ?></span>
                                            </td>
                                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\faculty-evaluation\resources\views/content/data-management/dm-schedules.blade.php ENDPATH**/ ?>