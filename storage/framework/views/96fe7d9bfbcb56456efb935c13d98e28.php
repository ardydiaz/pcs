...
<div class="container-fluid">
    ...
    <div class="filter-card">
        <form method="GET" action="<?php echo e(route('um.audit-logs')); ?>" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <select name="action" class="form-select">
                    ...
                    <option value="faculty_created" <?php echo e(request('action') === 'faculty_created' ? 'selected' : ''); ?>>Faculty Created</option>
                    <option value="user_registration" <?php echo e(request('action') === 'user_registration' ? 'selected' : ''); ?>>User Registration</option>
                </select>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2 d-flex align-items-end">
                <div class="d-grid w-100 gap-2">
                    ...
                    <a href="<?php echo e(route('um.audit-logs')); ?>" class="btn btn-outline-secondary btn-sm">
                        Clear
                    </a>
                </div>
            </div>
                ...
                <table class="table table-hover logs-table mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="fw-medium"><?php echo e($log->created_at->format('M d, Y')); ?></div>
                                    <small class="text-muted"><?php echo e($log->created_at->format('h:i A')); ?></small>
                                </td>
                                <td>
                                    <div class="fw-medium"><?php echo e($log->name); ?></div>
                                </td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge action-badge <?php echo e($actionClass); ?>">
                                ...
                                <td>
                                    <?php if($log->method): ?>
                                        <span class="badge bg-label-secondary"><?php echo e($log->method); ?></span>
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <code class="text-body"><?php echo e($log->ipAddress ?: '-'); ?></code>
                                </td>
                                <td>
                                    <div class="user-agent-cell" title="<?php echo e($log->userAgent); ?>">
                                        <?php echo e($log->userAgent ?: '-'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\postclasssurvey\resources\views/content/audit-logs/audit-logs.blade.php ENDPATH**/ ?>