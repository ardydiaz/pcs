...
(() => {
    ...
    class TableController {
        ...
        collectRows() {
            ...
            this.rows = allRows.filter((row) => row !== this.emptyRow && !row.hasAttribute('data-ignore'));
        }
        ...
        render() {
            ...
            if (this.emptyRow) {
                this.emptyRow.style.display = this.filteredRows.length === 0 ? '' : 'none';
            }
...
<?php /**PATH C:\laragon\www\post-class-survey\resources\views/components/table-controller-script.blade.php ENDPATH**/ ?>